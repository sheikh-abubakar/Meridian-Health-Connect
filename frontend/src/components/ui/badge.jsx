...
const badgeVariants = cva("inline-flex items-center rounded-md px-2.5 py-1 text-xs font-medium", {
  variants: {
    variant: {
      ...
      expired: "bg-amber-50 text-amber-800 ring-1 ring-inset ring-amber-200",
      skipped_opt_out: "bg-amber-50 text-amber-800 ring-1 ring-inset ring-amber-200",
      skipped_invalid_contact: "bg-red-50 text-red-700 ring-1 ring-inset ring-red-200",
    },
