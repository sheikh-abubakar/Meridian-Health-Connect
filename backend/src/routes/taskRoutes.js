...
import { completeTask, createTask, listCriticalTasks, listTasks, recordTaskOutcome } from "../controllers/taskController.js";
...
taskRouter.get("/critical", authorizeRoles("admin"), listCriticalTasks);
