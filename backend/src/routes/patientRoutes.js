...
import { staffMessages, staffSendMessage } from "../controllers/messageController.js";
...
patientRouter.get("/:id/messages", authorizeRoles("frontdesk", "admin", "doctor", "care_coordinator"), staffMessages);
