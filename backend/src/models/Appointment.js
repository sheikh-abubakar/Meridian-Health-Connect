...
const appointmentSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: ["scheduled", "checked_in", "completed", "cancelled", "rescheduled", "no_show"],
      default: "scheduled",
    },
    ...
    cancellationReasonCode: { type: String, trim: true, maxlength: 80 },
    cancelledAt: { type: Date },
    rescheduledAt: { type: Date },
    rescheduledToAppointmentId: { type: mongoose.Schema.Types.ObjectId, ref: "Appointment" },
    rescheduledFromAppointmentId: { type: mongoose.Schema.Types.ObjectId, ref: "Appointment" },
    noShowAt: { type: Date },
